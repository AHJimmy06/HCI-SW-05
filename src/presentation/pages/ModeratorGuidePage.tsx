        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-slate-700 max-w-2xl text-sm font-medium">
              Manual de instrucciones paso a paso para asegurar una conducción ética, consistente y exitosa de la misión.
            </p>
          </div>
          <div className="flex items-center gap-2 text-sm text-primary font-semibold bg-primary/10 px-4 py-2 rounded-full border-2 border-primary/20">
            ...
            IHC: El Capitán evalúa la nave, no al tripulante
          </div>
        </div>
      </header>
        ...
        <section aria-labelledby="intro-heading" className="animate-in fade-in slide-in-from-left-4 duration-500 delay-75">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 id="intro-heading" className="text-xl font-bold text-slate-900">
              Briefing de Misión (Protocolo)
            </h2>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              { title: "Bienvenida", desc: "Agradece sinceramente su tiempo y participación voluntaria en esta misión.", icon: <CheckCircle2 className="text-green-700" size={20} /> },
              { title: "Foco en la Nave", desc: "Explica que evaluamos la interfaz y no sus capacidades personales.", icon: <AlertCircle className="text-primary" size={20} /> },
              { title: "Protocolo de Voz", desc: "Pide expresar pensamientos y dudas en voz alta constantemente (Think Aloud).", icon: <HelpCircle className="text-orange-800" size={20} /> },
              { title: "Ruta de Vuelo", desc: "Lee una tarea a la vez y permite que el usuario explore libremente.", icon: <ArrowRightCircle className="text-blue-800" size={20} /> },
              { title: "Neutralidad de Base", desc: "Evita dar pistas o gestos que influyan en el comportamiento de vuelo.", icon: <AlertCircle className="text-red-800" size={20} /> }
            ].map((step, index) => (
        ...
        <section aria-labelledby="guide-tasks-heading" className="animate-in fade-in slide-in-from-left-4 duration-500 delay-150">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 id="guide-tasks-heading" className="text-xl font-bold text-slate-900">
              Maniobras y Consultas de Campo
            </h2>
          </div>
              ...
              <table className="w-full text-sm text-left">
                <thead>
                  <tr className="bg-slate-50 border-b border-slate-200">
                    ...
                    <th scope="col" className="px-4 py-4 font-bold text-slate-900 w-[35%]">Guion para el tripulante</th>
                    <th scope="col" className="px-4 py-4 font-bold text-slate-900 w-[35%]">Consulta de seguimiento</th>
        ...
        <section aria-labelledby="closing-heading" className="animate-in fade-in slide-in-from-left-4 duration-500 delay-200 pb-10">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 id="closing-heading" className="text-xl font-bold text-slate-900">
              Debriefing y Reporte de Cierre
            </h2>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="space-y-2">
              <label htmlFor="closing_easy" className="text-sm font-bold text-slate-800 block">¿Navegación sin obstáculos?</label>
            ...
            <div className="space-y-2">
              <label htmlFor="closing_confusing" className="text-sm font-bold text-slate-800 block">¿Turbulencias detectadas?</label>
            ...
            <div className="space-y-2">
              <label htmlFor="closing_change" className="text-sm font-bold text-slate-800 block">¿Ajustes de ruta sugeridos?</label>
              <textarea id="closing_change" value={data.plan.closing_change} onChange={(e) => updatePlan('closing_change', e.target.value)} className="w-full h-32 p-4 bg-white border border-slate-200 rounded-2xl shadow-sm focus:ring-2 focus:ring-primary focus:border-primary transition-all text-sm font-medium text-slate-900" placeholder="Anota sugerencias del tripulante..." />
            </div>
          </div>
        </section>
